...
This is a basic example which shows how to search for a gene of interest across the SkeletalVis data. See the vignettee for a full tutorial of SkeletalVis.
